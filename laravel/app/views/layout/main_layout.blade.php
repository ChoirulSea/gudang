...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li id="abc" class="xn-title"><strong>Master</strong></li>
            <li id="abc" class="xn-openable">
                ...
                <ul>
                    ...
                    <li><a href="{{route('pkm-supplier')}}"><span class="fa fa-image"></span>Supplier</a></li>
                    <li><a href="{{route('dkk-pegawai')}}"><span class="fa fa-desktop"></span><span>Pegawai</span></a></li>
            ...
            <li id="asd" class="xn-title"><strong>Menu</strong></li>
            <li id="abc" class="xn-openable">
                <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Gudang</span></a>
                <ul>
                    <li>
                        <a href="{{route('pkm-masuk')}}"><span class="fa fa-desktop"></span>
                            <span class="xn-text">Penerimaan Barang</span></a>
            ...
            <li id="abc" class="xn-openable">
                <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Aset</span></a>
                <ul>
                    <li>
                        <a href="{{route('aset-masuk')}}"><span class="fa fa-desktop"></span> <span
                                    class="xn-text">Penerimaan Aset</span></a>

                        <div class="informer informer-warning" id="count2"></div>
                    </li>
                    <li>
                        <a href="{{route('aset-keluar')}}"><span class="fa fa-desktop"></span> <span
                                    class="xn-text">Pengeluaran Aset</span></a>
                    </li>
                </ul>
            </li>
            <li id="abc" class="xn-openable">
                <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Data Stok</span></a>
                <ul>
                    <li id="abc">
                        <a href="{{route('m-stok-pkm')}}"><span class="fa fa-desktop"></span> <span
                                    class="xn-text">Stok Habis Pakai</span></a>
                    </li>
                    <li id="abc">
                        <a href="{{route('aset-data')}}"><span class="fa fa-desktop"></span> <span
                                    class="xn-text">Data Aset</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li id="gudang">
                <a href="{{route('dkk-pegawai')}}"><span class="fa fa-desktop"></span> <span
                            class="xn-text">Pegawai</span></a>
            </li>
            <li class="xn-openable">
                <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">Extra</span></a>
                <ul>
                    <li>
                        <a href="{{route('aset-edit')}}"><span class="fa fa-clipboard"></span><span class="xn-text">Detail Aset</span></a>                        
                    </li>
                    <li>
                        <a href="{{route('aset-kib')}}"><span class="fa fa-clipboard"></span><span class="xn-text">KIB</span></a>
                    </li>
                    <li>
                        <a href="{{route('aset-kir')}}"><span class="fa fa-clipboard"></span><span class="xn-text">KIR</span></a>
                    </li>
                    <li>
                        <a href="{{route('laporan')}}"><span class="fa fa-clipboard"></span><span class="xn-text">Laporan Aset</span></a>
                    </li>
                </ul>
            </li>
            <li>&nbsp;</li>
    ...
    <div class="page-content">
        ...
        <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
            ...
            <li class="pull-right">
                <label style="font-size: 14pt;color: white;padding-top: 15%"><img style="padding-bottom: 5%" src="{{asset('img/logo-ic-white.png')}}">&nbsp;2015&nbsp;
                </label>&nbsp;&nbsp;&nbsp;
            </li>
            <!-- SIGN OUT
            <li class="xn-icon-button pull-right">
